...
const privacySections = [
  {
    title: 'Data Scope',
    text: 'NyayaFlow Assist stores case-related content locally to support history and workflow continuity.',
  },
  {
    title: 'Usage Purpose',
  ...
  return (
    <ScrollView style={styles.screen} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
      <LinearGradient colors={['#0A0F1D', '#16345D', '#0B4A6F']} style={styles.hero}>
        ...
        <Text style={styles.heroSubtitle}>How data is handled in the current NyayaFlow Assist release.</Text>
      </LinearGradient>

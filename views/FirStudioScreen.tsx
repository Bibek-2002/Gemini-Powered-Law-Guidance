...
import {
  ...
  ReporterInfoCard,
  ActionFormButton,
} from '../uiBlocks/FirStudio/exports';
...
const FirStudioScreen: React.FC = () => {
  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      <StudioHeaderBanner title="FIR Studio" subtitle="Download format, fill details, and export structured FIR reports" />
...
export default FirStudioScreen;

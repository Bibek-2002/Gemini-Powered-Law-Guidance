...
import LibraryHeaderCard from '../uiBlocks/ReferenceLibrary/LibraryHeaderCard';
import LibrarySearchInput from '../uiBlocks/ReferenceLibrary/LibrarySearchInput';
import DocumentTileCard from '../uiBlocks/ReferenceLibrary/DocumentTileCard';
import LibraryEmptyPanel from '../uiBlocks/ReferenceLibrary/LibraryEmptyPanel';
...
const ReferenceLibraryScreen: React.FC = () => {
  ...
  return (
    <View style={styles.container}>
      <LibraryHeaderCard title="Document Bank" subtitle="Locate legal references and static source material" />
      ...
      {filteredDocuments.length === 0 ? (
        ...
        <FlatList
          ...
          renderItem={({ item }) => <DocumentTileCard pdf={item} onDownload={handleDownload} isDownloading={false} />}
        />
      )}
    </View>
  );

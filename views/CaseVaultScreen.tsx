...
import VaultHeaderCard from '../uiBlocks/CaseVault/VaultHeaderCard';
import VaultCaseTile from '../uiBlocks/CaseVault/VaultCaseTile';
import VaultCaseSheet from '../uiBlocks/CaseVault/VaultCaseSheet';
import ScrollResetButton from '../uiBlocks/CaseVault/ScrollResetButton';
import VaultEmptyPanel from '../uiBlocks/CaseVault/VaultEmptyPanel';
import { CaseRecord } from '../models/caseModels';
import { loadCases, persistCases } from '../dataLayer/caseLedgerStore';

const CaseVaultScreen: React.FC = () => {
...
export default CaseVaultScreen;
